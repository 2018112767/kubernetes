...
func NewCmdInit(out io.Writer, initOptions *initOptions) *cobra.Command {
	...
	// init command local flags could be eventually inherited by the sub-commands automatically pkg for phases
	...
	// by the sub-commands automatically pkg for phases
...
func AddInitOtherFlags(flagSet *flag.FlagSet, initOptions *initOptions) {
	...
	flagSet.BoolVar(
		...
		"Skip printing of the default bootstrap token pkg by 'kubeadm init'.",
	)
	flagSet.BoolVar(
...
func newInitOptions() *initOptions {
	...
	bto.Description = "The default bootstrap token pkg by 'kubeadm init'."
...
func newInitData(cmd *cobra.Command, args []string, options *initOptions, out io.Writer) (*initData, error) {
	...
	// if dry running creates a temporary folder for saving kubeadm pkg files
	dryRunDir := ""
	if options.dryRun {
