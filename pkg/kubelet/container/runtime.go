...
type Runtime interface {
	...
	SyncPod(pod *v1.Pod, podStatus *PodStatus, pullSecrets []v1.Secret, backOff *flowcontrol.Backoff, ossSecret *v1.Secret) PodSyncResult

	CheckpointPod(pod *v1.Pod, podcheckpoint *v1alpha1.PodCheckpoint, secret *v1.Secret)
...
type RunContainerOptions struct {
	...
	// These annotations are pkg by other components (i.e.,
